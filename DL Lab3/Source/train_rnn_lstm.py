...
# Data loading params
tf.flags.DEFINE_string("pos_dir", "data/reviewdata/review.pos.txt", "Path of positive data")
tf.flags.DEFINE_string("neg_dir", "data/reviewdata/review.neg.txt", "Path of negative data")
...
tf.flags.DEFINE_string("cell_type", "rnn", "Type of rnn cell. Choose 'rnn' or 'lstm' or 'gru' (Default: rnn)")
...
tf.flags.DEFINE_float("learning_rate", 1e-4, "Which learning rate to start with. (Default: 1e-3)")
